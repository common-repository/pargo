  ...
  methods: {
    generateNewTokenRequest() {
      return _e(this, null, function* () {
        this.messages = [], this.errors = [], confirm("You will need to notify Pargo of your new token, continue?") && (yield fetch(`${OBJ.api_url}pargo/v1/regenerate-token`, {
          ...
          i.data && i.data.status && i.data.status === 500 && this.errors.push(i.message), i.api_token && (this.messages.push(i.message), i.api_token && (this.pargoUser.api_token = i.api_token));
        })).catch((i) => {
    ...
    copyAPIToken() {
      return _e(this, null, function* () {
        ...
        const i = (t) => new Promise((e, s) => {
          if (typeof navigator != "undefined" && typeof navigator.clipboard != "undefined") {
            const n = "text/plain", r = new Blob([t], { type: n }), o = [new ClipboardItem({ [n]: r })];
            navigator.clipboard.write(o).then(e, s).catch(s);
          } else if (document.queryCommandSupported && document.queryCommandSupported("copy")) {
            const n = document.createElement("textarea");
            n.textContent = t, n.style.display = "none", document.body.appendChild(n), n.focus(), n.select();
            try {
              document.execCommand("copy"), document.body.removeChild(n), e();
            } catch (r) {
              document.body.removeChild(n), s(r);
            }
          } else
            s(new Error("None of copying methods are supported by this browser!"));
        });
        try {
          yield i(this.pargoUser.api_token), this.messages.push("Copied Webhook Auth token");
        } catch (t) {
          this.errors.push("Failed to automatically copy Webhook Auth token to clipboard, click on the token to copy manually or contact support@pargo.co.za for assistance.");
        }
      });
    },
    ...
    V("form", null, [
      ...
      V("div", Yb, [
        ...
        V("button", {
          ...
          type: "button",
          onClick: t[8] || (t[8] = (o) => {
            r.generateNewTokenRequest().then(r.copyAPIToken);
          })
        }, "Generate New Token"),
        ty
      ]),
...
const cy = /* @__PURE__ */ kn(yb, [["render", uy], ["__scopeId", "data-v-0c8fb42f"]]);
class ct {
  constructor() {
  }
  lineAt(t) {
...
}, IS = (i) => (yd("data-v-a8bc1b70"), i = i(), wd(), i), QS = { class: "p-pargo-info" }, zS = /* @__PURE__ */ IS(() => /* @__PURE__ */ V("b", null, "Login", -1)), WS = /* @__PURE__ */ Ui(" to your myPargo account"), $S = [
  zS,
  WS
], FS = /* @__PURE__ */ L0('<div class="item" data-v-a8bc1b70><h2 data-v-a8bc1b70>South Africa</h2><p data-v-a8bc1b70><b data-v-a8bc1b70>Email Pargo:</b> <a href="mailto:info@pargo.co.za" data-v-a8bc1b70>info@pargo.co.za</a></p><p data-v-a8bc1b70><b data-v-a8bc1b70>Call Pargo:</b> <a href="tel:+27 21 447 3636" data-v-a8bc1b70> +27 21 447 3636 </a></p><p data-v-a8bc1b70><b data-v-a8bc1b70>About Pargo:</b> <a href="https://pargo.co.za/faq/" target="_blank" data-v-a8bc1b70>Frequently Asked Questions</a></p></div><div class="item" data-v-a8bc1b70><h2 data-v-a8bc1b70>Egypt</h2><p data-v-a8bc1b70><b data-v-a8bc1b70>Email Pargo:</b> <a href="mailto:support.eg@pargo.com" data-v-a8bc1b70>support.eg@pargo.com</a></p><p data-v-a8bc1b70><b data-v-a8bc1b70>Call Pargo:</b> <a href="tel:+20 100 326 5919" data-v-a8bc1b70> +20 100 326 5919 </a></p><p data-v-a8bc1b70><b data-v-a8bc1b70>About Pargo:</b> <a href="https://eg.pargo.com/faq/" target="_blank" data-v-a8bc1b70>Frequently Asked Questions</a></p></div>', 2);
...
const US = /* @__PURE__ */ kn(LS, [["render", VS], ["__scopeId", "data-v-a8bc1b70"]]);
const jS = {
  name: "PargoMap",
  props: {
    mapToken: {
